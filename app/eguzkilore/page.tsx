...
export default function EguzkilorePage() {
  return (
    <main className="min-h-screen bg-[#0B0B0C] text-[#F2F2F0]">
      ...
      >
        {/* Opening */}
        <p style={{ fontSize: "clamp(1.5rem, 2.5vw, 2rem)", fontWeight: 500, color: "#F2F2F0", letterSpacing: "-0.02em", lineHeight: 1.3, marginBottom: "3rem" }}>
          Se rieron cuando saqué una baraja del bolsillo...<br />
          hasta que terminé el primer truco.
        </p>

        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic", marginBottom: "2rem" }}>
        ...
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"A ver, haz algo."</p>
        <p>Saco la baraja y, justo antes de abrirla, escucho la frase que he oído decenas de veces:</p>
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"¿Siempre llevas una baraja encima?"</p>
        <p>El tono lo dice todo: Un poco de burla, un poco de incredulidad.</p>
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"Sí. Soy un friki."</p>
        ...
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"Te tiemblan las manos, jajaja."</p>
        <p>No falla. Siempre hay alguien que intenta ponerse por encima.</p>
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"Es que me pones nervioso."</p>
        ...
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"¿Cómo lo has hecho?"</p>
        ...
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"¡Tío, hazte otro! Espera, espera… que llamo a un colega para que vea esto."</p>
        ...
        <div style={{ margin: "2.5rem 0" }}>
          <p style={{ fontSize: "clamp(1.4rem, 2vw, 1.8rem)", fontWeight: 500, color: "#F2F2F0", letterSpacing: "-0.02em", lineHeight: 1.3 }}>
        ...
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"Si queréis más, sacad la cartera."</p>
        ...
        <p style={{ color: "rgba(242,242,240,0.55)", fontStyle: "italic" }}>"Pero... ¿cómo cojones haces eso?"</p>
        ...
        <div style={{ height: "1px", background: "rgba(242,242,240,0.08)", margin: "3rem 0" }} />
        ...
        <p>Por eso diseñé la baraja <strong style={{ color: "#F2F2F0" }}>EGUZKILORE</strong>.</p>
        ...
        <p style={{ fontSize: "clamp(1.2rem, 1.6vw, 1.4rem)", color: "#F2F2F0", fontWeight: 500 }}>
        ...
        <ul style={{ paddingLeft: "1.5rem", color: "rgba(242,242,240,0.65)" }}>
        ...
        <p>Pero <strong style={{ color: "#F2F2F0" }}>EGUZKILORE</strong> no te va a costar 90 €</p>
        <p>Tampoco 40 €.<br />Ni siquiera 20 €.</p>

        <div style={{ margin: "2.5rem 0" }}>
          <p style={{ fontSize: "clamp(1.6rem, 2.5vw, 2.2rem)", fontWeight: 500, color: "#F2F2F0", letterSpacing: "-0.02em", lineHeight: 1.3 }}>
            El precio de lanzamiento es de tan solo 12 €.
          </p>
          <p style={{ color: "rgba(242,242,240,0.65)", marginTop: "0.75rem" }}>
            Sí, menos de lo que cuesta un juego de mesa barato.<br />Y lo mejor: el curso viene incluido de regalo.
          </p>
        </div>
        ...
        <div style={{ textAlign: "center", marginTop: "3.5rem" }}>
          <a
            ...
            className="hover:border-white/50 hover:text-[#2ED3E6]"
          >
